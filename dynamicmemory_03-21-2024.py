...
model.W_ff_0 = .04     # Scales the FF weights - affects the next layer's amplitude
model.W_ff_1 = -.003       # Shifts the FF weights 
model.W_fb_0 = .04   # Scales the FB weights - affects the prev layer's amplitude
...
model.W_ff_1 = -.000       # Shifts the FF weights 
model.W_fb_0 = .03   # Scales the FB weights - affects the prev layer's amplitude
model.W_fb_1 = -.000        # Shifts the FB weights 
